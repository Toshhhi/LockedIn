...
const Login = () => {
 return (
  <div className="min-h-screen flex items-center justify-center p-2 bg-black">
    ...
    <div className="w-full max-w-[1200px] border-[10px] border-[#8A7EA8] rounded-3xl overflow-hidden flex">

      {/* Left Section */}
      <div className="w-1/2 bg-[#0D0D0D] text-[#EDEDED] flex flex-col items-center  justify-center p-12">
        <img src={logo} alt="logo" className="h-70 mb-4 pb-4" />
        <h1
      ...
      <div className="w-1/2 bg-[#0D0D0D] flex items-center justify-center p-8">
        <div className="border border-[#8A7EA8] p-16 rounded-2xl shadow-lg w-full max-w-lg">
